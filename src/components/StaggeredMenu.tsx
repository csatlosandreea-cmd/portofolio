  ...
  return (
    ...
    >
      ...
      >
        ...
        <header
          className="staggered-menu-header backdrop-blur-md absolute top-0 left-0 w-full max-h-screen! flex items-center justify-between px-4 py-2 bg-transparent pointer-events-none z-20"
        ...
        >
          <div className="sm-logo flex items-center select-none pointer-events-auto" aria-label="Logo">
            <Image
              ...
              width={300}
              height={300}
              className="sm-logo-img block w-30 object-contain"
            />
          </div>
        ...
        >
          <div className="sm-panel-inner flex-1 flex flex-col gap-5">
            <ul
              className="sm-panel-list list-none m-0 p-0 flex flex-col gap-2 after:right-16!"
              role="list"
              ...
              {items && items.length ? (
                items.map((it, idx) => (
                  <li className="sm-panel-itemWrap relative overflow-hidden leading-none" key={it.label + idx}>
                    <a
                      className="sm-panel-item relative text-black font-semibold text-5xl! my-4 cursor-pointer leading-none tracking-[-2px] uppercase transition-[background,color] duration-150 ease-linear inline-block no-underline pr-[1.4em]"
                      href={it.link}
